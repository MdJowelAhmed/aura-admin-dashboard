  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-white/20 mt-4 rounded-lg backdrop-blur-sm px-6 py-4 mb-2 border border-white/30">
        <div className="grid grid-cols-[50px_1fr_1fr_1fr_1fr_1fr_80px_160px] gap-4 text-[16px] font-medium text-white">
          ...
          {promos.map((p) => (
            ...
            >
              <div className="grid grid-cols-[50px_1fr_1fr_1fr_1fr_1fr_80px_160px] gap-4 items-center text-sm">
                ...
                <div className="text-[#100F0E]">{p.startTime}</div>
                <div className="text-[#100F0E]">{p.endTime}</div>
                ...
                <div>
                  ...
                  >
                    {toggleStates[p.id] ? "Active" : "Inactive"}
                  </span>
                </div>
                ...
                <div className="flex justify-center items-center gap-2 w-[125px] mx-auto border border-cyan-500 rounded-sm">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-4 w-10 items-center rounded-full transition-colors focus:outline-none ${
                      toggleStates[p.id] ? "bg-cyan-500" : "bg-gray-300"
                    }`}
                  >
                    <span
                      className={`inline-block h-3 w-3 transform rounded-full bg-white transition-transform ${
                        toggleStates[p.id] ? "translate-x-6" : "translate-x-1"
                      }`}
                    />
                  </button>
